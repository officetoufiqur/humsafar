...
class ProfileAttributeSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $data = [
            ...
            ['label' => 'Relation Status', 'values' => json_encode([]), 'showOn' => true, 'created_at' => now(), 'updated_at' => now()],
            ...
            ['label' => 'Am Looking for', 'values' => json_encode([]), 'showOn' => true, 'created_at' => now(), 'updated_at' => now()],
            ...
            ['label' => 'I am a', 'values' => json_encode([]), 'showOn' => true, 'created_at' => now(), 'updated_at' => now()],
